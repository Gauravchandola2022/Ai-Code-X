...
nlp_text.config(bg='black',fg='white', insertbackground='white')
...
c_code_text.config(bg='black',fg='white', insertbackground='white')
...
output_text.config(bg='black',fg='white', insertbackground='white')
